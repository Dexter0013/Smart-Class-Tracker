...
export default function ChatBot({
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 w-96 h-[600px] bg-white rounded-lg shadow-2xl z-50 flex flex-col ${className}`}
    >
      {/* Header */}
      ...
      >
        <input
          ...
          disabled={loading}
          className="flex-1 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-600 text-gray-900 placeholder-gray-500"
        />
        <button
          type="submit"
